...
//
static DEFOPCODE(00BF, GET_TIME_OF_DAY, vv);
inline void GET_TIME_OF_DAY(int* hour, int* minute)
{
    CallScriptCommand(&scm_GET_TIME_OF_DAY, hour, minute);
}
...
static DEFOPCODE(020A, SET_CAR_DOOR_STATUS, ii);
inline void SET_CAR_DOOR_STATUS(int car, int lockStatus)
{
